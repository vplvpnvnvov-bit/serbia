...
const masterTimeline = [
  {
    ...
    tasks: [
      ...
      { 
        ...
        tip: "<p><b>Где делать:</b> В архиве ЗАГС или через МФЦ по месту регистрации рождения.</p><p><b>Пошлина:</b> 2 500 руб.</p><p><b>Зачем:</b> Облегчает процедуру признания документов и зачисления в государственные образовательные учреждения Сербии.</p>" 
      },
      { 
        id: "power", 
      ...
      { 
        ...
        tip: "<p><b>Правила:</b> Согласно ст. 20 Федерального закона № 114-ФЗ 'О порядке выезда из РФ и въезда в РФ', согласие требуется, если ребенок едет без сопровождения хотя бы одного из родителей. Если летите всей семьей, согласие не нужно, но рекомендуется для бесконфликтного прохождения погранконтроля.</p>" 
      },
      { 
        id: "dentist", 
      ...
      { 
        ...
        tip: "<p><b>Важно:</b> Перевозка рецептурных препаратов регулируется таможенными правилами. Возьмите с собой рецепты, оформленные по правилам Минздрава РФ, с обязательным указанием Международных непатентованных наименований (МНН) на латыни.</p>" 
      },
      { 
        id: "med_vyps", 
  ...
  },
  {
    ...
    tasks: [
      ...
      { 
        ...
        tip: "<p>При бронировании проверяйте согласие хозяина предоставить белый картон. Не соглашайтесь на бронирование без письменного подтверждения этой опции в чате.</p>" 
      },
      { 
        id: "reg", 
