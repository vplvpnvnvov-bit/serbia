...
const CHECKLIST = [
  { cat: "📄 Выезд из РФ", items: [
    ...
    { id:"nocrim_h", text:"Справка о несудимости (муж) — бумажная, с живой печатью", price:"", hasDate:true, link:"", tip:"Госуслуги → Услуги → Справки, выписки → Справка о наличии (отсутствии) судимости.\n\nШаг 1: Заказать онлайн (заполнить 2 минуты).\nШаг 2: Через 2–3 дня придёт уведомление.\nШаг 3: Забрать ГОТОВУЮ справку в МВД (распечатка с Госуслуг НЕ подойдёт).\nСрок действия — 6 месяцев. Рекомендуется сразу поставить апостиль." },
    { id:"nocrim_w", text:"Справка о несудимости (жена) — бумажная, с живой печатью", price:"", hasDate:true, link:"", tip:"То же, что для мужа.\n\nГосуслуги → Услуги → Справки, выписки → Справка о наличии (отсутствии) судимости.\nСрок действия — 6 месяцев. При подаче на ВНЖ сербский МУП может потребовать апостилированную справку." },
    { id:"nocrim_apost", text:"Апостиль на справки о несудимости (муж + жена)", price:"5000", hasDate:true, link:"", tip:"Сдать оригинал справки в МФЦ или Минюст.\nГоспошлина ~2500₽ за каждую.\nСрок — до 5 рабочих дней.\nВ 2026 году сербские банки и МУП всё чаще требуют апостилированные справки." },
  ...
  { cat: "📄 Апостили и легализация", items: [
    { id:"apost_marr", text:"Апостиль на свидетельство о браке (оригинал)", price:"2500", hasDate:true, link:"", tip:"Сдать оригинал свидетельства в МФЦ или ЗАГС.\nГоспошлина 2500₽.\nСрок — до 5 рабочих дней.\nБез апостиля супруге могут отказать в ВНЖ на основании вашего ИП." },
    { id:"apost_birth", text:"Апостиль на свидетельство о рождении ребёнка", price:"2500", hasDate:true, link:"", tip:"Сдать оригинал в МФЦ или ЗАГС.\nПотребуется для ВНЖ ребёнка и в будущем для записи в сад/школу." },
    { id:"apost_diploma", text:"Апостиль на диплом об образовании (с приложением)", price:"2500", hasDate:true, link:"", tip:"Заказать в Минобрнауки или МФЦ.\nГоспошлина 2500₽.\nСрок ~30 дней.\nНужен для нострификации (подтверждения диплома) в Сербии." },
