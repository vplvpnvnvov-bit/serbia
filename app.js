window.APP_CONFIG = {
  VERSION: "1.81.99",
  BUILD: "5b27c65",
  CACHE_NAME: "relocation-v1.81.99-5b27c65"
};
...
const masterTimeline = [
  {
    ...
    tasks: [
      { 
        ...
        cost: 6000, 
        currency: "RUB", 
        desc: "Оформить биометрический паспорт нового образца с чипом.", 
        tip: "<p><b>Где делать:</b> Подать заявление через Госуслуги РФ или в МФЦ.</p><p><b>💡 Практика в Сербии (Связь с Месяцем 3):</b> Этот паспорт — фундамент. Именно на него в Месяце 3 в APR будет регистрироваться ИП (задача <b>preduzetnik</b>) и открываться бизнес-счёт (задача <b>m3_bank_business</b>). Наклейки ВНЖ (бороваки) ставятся тоже сюда.</p>", 
        hasDate: true, 
        expires: 120 
      },
      { 
        ...
        tip: "<p><b>⚠️ Важнейший нюанс (Транслитерация):</b> Буква в букву сверяйте написание фамилии с будущим свидетельством о браке. Расхождение даже в один символ сорвёт семейное воссоединение на eUprava в Сербии (задача <b>m1_vnz_submit</b>).</p>", 
        hasDate: true, 
        expires: 120 
      },
      { 
        ...
        tip: "<p><b>Нюанс:</b> Малышам лучше делать 5-летний паспорт — они быстро растут и меняются внешне, из-за чего на границе могут возникнуть вопросы к биометрии 3-летней давности. Делается быстро (1.5–2 недели).</p>", 
        hasDate: true, 
        expires: 60 
      },
      { 
        ...
        tip: "<p><b>🔥 Приоритет №1:</b> Без этой красной печати районного МВД вам легально откажут в выпуске детского загранпаспорта (задача <b>p5d</b>) и не выпустят на паспортном контроле в Шереметьево.</p>" 
      },
      { 
        id: "nocrim_h", 
        ...
        cost: 0, 
        currency: "RUB", 
        desc: "Заказать электронную версию с ЭЦП МВД на Госуслугах.", 
        tip: "<p><b>💡 Лайфхак:</b> Заказывайте строго электронную версию с ЭЦП сотрудников ведомства (.sig) — она делается 1–5 дней вместо месяца для бумажной. Согласно ст. 15 Договора между СССР и ФНРЮ от 1962 года, документы с госпечатью освобождены от Апостиля. Но для перестраховки мы ставим Апостиль далее.</p>" 
      },
      { 
        id: "nocrim_w", 
        ...
        currency: "RUB", 
        desc: "Заказать электронную версию с ЭЦП МВД на Госуслугах.", 
        tip: "<p><b>Зачем:</b> Справка строго обязательна для личного дела при воссоединении семьи в МУП Сербии. Срок её действия на момент подачи в Белграде — не более 6 месяцев!</p>" 
      },
      { 
        id: "apost_marr", 
        ...
        cost: 2500, 
        currency: "RUB", 
        desc: "Пошлина за штамп Апостиль на оригинал документа в ЗАГС.", 
        tip: "<p><b>Зачем на практике:</b> Юридически соглашение 1962 года отменяет легализацию. Но инспекторы МУП в Белграде часто не знают международное право и требуют апостиль 'по привычке'. Поставьте его в Главном управлении ЗАГС, чтобы не спорить в полиции Сербии.</p>" 
      },
      { 
        id: "apost_birth", 
        ...
        cost: 2500, 
        currency: "RUB", 
        desc: "Пошлина за штамп Апостиль на оригинал в архиве ЗАГС.", 
        tip: "<p><b>Критично:</b> Этот документ с апостилем потребуется не только для ВНЖ ребёнка, но и в обязательном порядке для зачисления в сербский детский сад (задача <b>m2_kindergarten</b>) департаментом образования Белграда.</p>" 
      },
      { 
        id: "apost_nocrim_h", 
        ...
        cost: 2500, 
        currency: "RUB", 
        desc: "Проставление апостиля на распечатанную справку МВД.", 
        tip: "<p><b>Зачем:</b> Исключает любые вопросы со стороны сербской миграционной службы. Делается в ИЦ МВД или ГУ МВД вашего региона за 5 рабочих дней.</p>" 
      },
      { 
        id: "apost_nocrim_w", 
        ...
        cost: 2500, 
        currency: "RUB", 
        desc: "Проставление апостиля на распечатанную справку жены.", 
        tip: "<p><b>Зачем:</b> Пакет документов жены на ВНЖ проверяется так же строго, как и пакет руководителя ИП. Позволяет избежать задержек рассмотрения дела.</p>" 
      },
      { 
        id: "power", 
        ...
        cost: 2000, 
        currency: "RUB", 
        desc: "Оформить у нотариуса на родителей или проверенных друзей.", 
        tip: "<p><b>Что включить:</b> Полные права в ФНС (налоговая), ПФР, судах, любых банках (закрытие счетов, перевыпуск карт, ячейки), Почте России (получение судебных писем) и право передоверия. Делайте на 5–10 лет. Находясь в Сербии, удалённо управлять делами в РФ без неё невозможно.</p>", 
        hasDate: true, 
        expires: 120 
      },
      { 
        ...
        cost: 2000, 
        currency: "RUB", 
        desc: "Оформить у нотариуса согласие на проживание за границей.", 
        tip: "<p><b>⚠️ Важнейшее требование Сербии:</b> Независимо от законов РФ, сербское Управление по делам иностранцев МУП при рассмотрении дела о ВНЖ для ребёнка <b>в обязательном порядке</b> затребует письменное нотариальное согласие от второго родителя, если он не подаётся на ВНЖ одновременно с ним по одному адресу.</p>" 
      },
      { 
        id: "dentist", 
        ...
        cost: 0, 
        currency: "RUB", 
        desc: "Полная плановая санация полости рта перед вылетом.", 
        tip: "<p><b>Почему это экономия тысяч евро:</b> Государственная страховка в Сербии (здравственная книжица, задача <b>state_health_insurance</b>) покрывает взрослым только экстренное удаление при острой боли. Любые пломбы, чистки и каналы в частных клиниках Белграда стоят в 1.5–2 раза дороже, чем в РФ.</p>" 
      },
      { 
        id: "pharm", 
        ...
        cost: 0, 
        currency: "RUB", 
        desc: "Запас необходимых личных препаратов на 3–6 месяцев.", 
        tip: "<p><b>Что учесть:</b> Специфические рецептурные лекарства берите с запасом и бумажным рецептом врача (где активное вещество указано на латыни по МНН). На Почте/Таможне Сербии строгий контроль. Обязательно возьмите детские жаропонижающие сиропы — в Сербии другие торговые марки, к которым нужно привыкать.</p>" 
      },
      { 
        id: "med_vyps", 
        ...
        cost: 0, 
        currency: "RUB", 
        desc: "Заключения врачей и карты с диагнозами по МКБ-10/11.", 
        tip: "<p><b>Зачем:</b> Все диагнозы и схемы лечения должны быть переведены или написаны с использованием латинских наименований веществ. Это позволит сербским терапевтам в государственных Dom Zdravlja мгновенно выписать вам местные рецепты без дорогой повторной диагностики.</p>" 
      },
      { 
        id: "airbnb_book", 
        name: "Забронировать временное жильё на Airbnb", 
        cost: 0, 
        currency: "RUB", 
        desc: "Поиск и бронирование апартаментов в Белграде на первые 30 дней.", 
        tip: "<p><b>🔥 Критично:</b> До оплаты пишите хосту: <i>'Da li možete da nam uradite beli karton u policiji u roku od 24 sata?'</i>. Если он колеблется — ищите другую квартиру. Без белого картона (задача <b>reg</b>) вы окажетесь нелегалами на следующий же день после прилёта.</p>" 
      },
      { 
        id: "ticket_buy", 
        ...
        cost: 120000, 
        currency: "RUB", 
        desc: "Покупка билетов Москва — Белград (Air Serbia с багажом).", 
        tip: "<p><b>Совет:</b> Оформляйте билеты на всех членов семьи в рамках одного бронирования, чтобы на стойке регистрации в Шереметьево вам гарантированно выдали места рядом.</p>" 
      },
      { 
        id: "diplomas", 
        ...
        cost: 0, 
        currency: "RUB", 
        desc: "Сбор физических оригиналов дипломов и вкладышей. Нотариальные копии в РФ НЕ НУЖНЫ.", 
        tip: "<p><b>⚠️ Защита от потери денег:</b> Не переводите диплом в РФ. Сербское агентство AZK принимает переводы строго от локальных специалистов (sudski tumač). В Месяце 1 этот документ уйдёт на физический перевод (задача <b>m1_trans_diploma</b>) и онлайн-подачу (задача <b>m1_azk_submit</b>).</p>" 
      },
      { 
        id: "driving_licenses", 
        ...
        cost: 0, 
        currency: "RUB", 
        desc: "Взять оригиналы пластиковых ВУ всех водящих членов семьи.", 
        tip: "<p><b>Как это работает в Сербии:</b> Права полностью легальны, пока вы в статусе туриста. После одобрения ВНЖ у вас будет ровно 6 месяцев, чтобы совершить три физических шага в Месяце 4: перевод прав (<b>m4_license_trans</b>), медкомиссия (<b>m4_license_med</b>) и личный визит в дорожную полицию (<b>m4_license_mup</b>).</p>" 
      }
    ]
  },
  {
    ...
    tasks: [
      { 
        id: "m1_flight", 
        name: "Физический перелёт в Белград", 
        cost: 0, 
        currency: "EUR", 
        desc: "Прибытие в аэропорт Никола Тесла, прохождение контроля.", 
        tip: "<p>На паспортном контроле просто показываете загранпаспорта. С этого момента у вас есть ровно 24 часа для получения Белого картона.</p>" 
      },
      { 
        id: "m1_airbnb", 
        name: "Заселение во временное жильё Airbnb", 
        cost: 950, 
        currency: "EUR", 
        desc: "Оплата первого месяца проживания хосту.", 
        tip: "<p>Стоимость включает долгосрочную скидку платформы. При заселении сразу напомните хозяину про регистрацию.</p>" 
      },
      { 
        id: "reg", 
        name: "Получение Белого картона (Beli karton)", 
        cost: 0, 
        currency: "EUR", 
        desc: "Регистрация в местной станице полиции в течение 24 часов.", 
        tip: "<p><b>Что проверить:</b> Если хост регистрирует вас онлайн через eTurista, он выдаст распечатку А4. Внимательно проверьте номера паспортов и даты рождения. Ошибка в одну цифру сделает документ недействительным для подачи на ВНЖ!</p>", 
        hasDate: true 
      },
      { 
        id: "sim", 
        name: "Покупка сим-карт сербских операторов", 
        cost: 10, 
        currency: "EUR", 
        desc: "Prepaid-пакеты Yettel или A1 в киоске Moj Kiosk.", 
        tip: "<p>Для покупки туристической prepaid-карты паспорт не нужен. Берите пакеты с большим объёмом гигабайт (15–50 ГБ) для первоначальной навигации и связи.</p>" 
      },
      { 
        id: "m1_trans_base", 
        ...
        tip: "<p><b>Физический шаг:</b> Отдайте оригиналы и апостили, полученные в Месяце 0, сертифицированному переводчику в Белграде. Это обязательный базовый пакет для миграционной полиции.</p>" 
      },
      { 
        id: "m1_trans_diploma", 
        ...
        cost: 80, 
        currency: "EUR", 
        desc: "Отдельный заверенный перевод диплома с оценками.", 
        tip: "<p>Оплачивается отдельно из-за большого объёма текста во вкладыше. Потребуется на следующем шаге подачи в AZK.</p>" 
      },
      { 
        id: "m1_trans_vax", 
        ...
        cost: 30, 
        currency: "EUR", 
        desc: "Перевод российской формы 063/у на сербский язык.", 
        tip: "<p><b>Важно:</b> Сделайте этот перевод сейчас. Без него в Месяце 2 администрация детского сада (задача <b>m2_kindergarten</b>) откажет в приёме ребёнка.</p>" 
      },
      { 
        id: "m1_azk_submit", 
        ...
        tip: "<p>Прикрепите цветной скан оригинала и перевод из задачи <b>m1_trans_diploma</b>. Электронная квитанция с номером дела — ваш официальный документ для подтверждения основания ВНЖ 'Талант'.</p>" 
      },
      { 
        id: "m1_insurance", 
        name: "Оформление коммерческих медстраховок на 1 год", 
        cost: 250, 
        currency: "EUR", 
        desc: "Локальный годовой полис Dunav Osiguranje или Globos на троих.", 
        tip: "<p>Обязательный документ для миграционной полиции. Проверьте наличие пункта о покрытии экстренной помощи на сумму не менее 10 000 EUR на человека.</p>", 
        hasDate: true, 
        expires: 12 
      },
      { 
        id: "m1_vnz_tax", 
        name: "Оплата госпошлин МУП за Единое разрешение", 
        cost: 600, 
        currency: "EUR", 
        desc: "Физическая оплата пошлин (~22 000 RSD на человека) в кассе Pošta Srbije.", 
        tip: "<p><b>Физический шаг:</b> Сгенерируйте квитанции на eUprava через систему Plati, распечатайте их и оплатите наличными динарами на почте. Бумажные чеки с мокрой печатью отсканируйте.</p>" 
      },
      { 
        id: "m1_vnz_submit", 
        ...
        tip: "<p>В личном кабинете eUprava прикрепите сканы белых картонов, страховок, переводов личных документов, справки из AZK и чеков с почты. Отправьте заявление на рассмотрение.</p>" 
      },
      { 
        id: "m1_living", 
        ...
        cost: 600, 
        currency: "EUR", 
        desc: "Первоначальные бытовые расходы семьи из 3 человек.", 
        tip: "<p>Включает покупку продуктов в Maxi/Lidl, проездные билеты Beograd Plus и оплату мобильного интернета.</p>" 
      },
      { 
        id: "m1_pediatrician", 
        ...
        cost: 50, 
        currency: "EUR", 
        desc: "Получение справки Potvrda o zdravstvenom stanju в MediGroup.", 
        tip: "<p><b>⚠️ Внимание:</b> Справка педиатра действительна строго 30 дней! Проходите осмотр непосредственно перед планируемым выходом в садик во втором месяце.</p>" 
      }
    ]
  },
  {
    ...
    tasks: [
      { 
        id: "m2_rent", 
        name: "Аренда постоянной квартиры (1-й месяц)", 
        cost: 600, 
        currency: "EUR", 
        desc: "Двушка на долгий срок, оформление письменного договора.", 
        tip: "<p><b>Критично:</b> Договор аренды (Ugovor o zakupu) заключается минимум на 1 год и должен содержать пункт о согласии собственника на регистрацию вашего места жительства. Рекомендуется нотариальное заверение (solenizacija).</p>", 
        hasDate: true 
      },
      { 
        id: "m2_deposit", 
        ...
        cost: 600, 
        currency: "EUR", 
        desc: "Гарантийный страховой депозит за сохранность имущества.", 
        tip: "<p><b>Совет:</b> В день заселения проведите тотальную видеофиксацию всех углов, сколов и техники, отправив видео хозяину в мессенджер, чтобы зафиксировать состояние жилья.</p>" 
      },
      { 
        id: "m2_agency", 
        ...
        cost: 300, 
        currency: "EUR", 
        desc: "Единоразовая оплата услуг агентства недвижимости недвижимости.", 
        tip: "<p>Стандартная ставка при поиске через HaloOglasi. Выплачивается строго в момент подписания договора и передачи ключей.</p>" 
      },
      { 
        id: "m2_utility", 
        ...
        cost: 150, 
        currency: "EUR", 
        desc: "Оплата Infostan (ЖКХ), электроэнергии EPS и интернета.", 
        tip: "<p><b>Лайфхак:</b> Электричество в Сербии дорогое. Включайте бойлер и стиральную машину в часы ночного льготного тарифа (с 22:00 до 06:00).</p>" 
      },
      { 
        id: "m2_kindergarten", 
        name: "Оплата частного детского сада (1-й месяц)", 
        cost: 400, 
        currency: "EUR", 
        desc: "Зачисление дочки в лицензированный частный садик.", 
        tip: "<p><b>Чек-лист документов:</b> Предоставьте справку от сербского педиатра (из Месяца 1) и перевод карты прививок 063/у (задача <b>m1_trans_vax</b>). Особое внимание уделяется вакцине MMR.</p>" 
      },
      { 
        id: "m2_living", 
        ...
        cost: 600, 
        currency: "EUR", 
        desc: "Регулярный ежемесячный бюджет ведения хозяйства.", 
        tip: "<p>Расходы на продукты питания, бытовую химию, мелкие покупки одежды и транспорт.</p>" 
      }
    ]
  },
  {
    month: 3,
    title: "Месяц 3: Запуск ИП и бизнес-инфраструктура",
    ...
    tasks: [
      { 
        ...
        cost: 750, 
        currency: "EUR", 
        desc: "Регулярные ежемесячные расходы на содержание постоянного жилья.", 
        tip: "<p>Оплата аренды хозяину квартиры и покрытие счетов Инфостан/EPS за текущий месяц.</p>" 
      },
      { 
        id: "m3_kindergarten", 
        ...
        cost: 400, 
        currency: "EUR", 
        desc: "Очередной плановый платёж за посещение детского сада.", 
        tip: "<p>Ежемесячное содержание ребёнка в дошкольном учреждении.</p>" 
      },
      { 
        id: "m3_living", 
        ...
        cost: 600, 
        currency: "EUR", 
        desc: "Повседневные семейные издержки на ведение быта.", 
        tip: "<p>Стабильный бюджет на питание и транспорт.</p>" 
      },
      { 
        id: "preduzetnik", 
        ...
        tip: "<p><b>Процесс:</b> Выберите код деятельности (для IT — <b>62.01</b>). Подайте заявление лично в офисе APR (ул. Brankova 25). Бумажное решение (Rešenje) с синей печатью выдаётся через 3–5 рабочих дней.</p>" 
      },
      { 
        id: "m3_office", 
        name: "Аренда виртуального офиса для ИП (на год)", 
        cost: 185, 
        currency: "EUR", 
        desc: "Оформление юридического адреса (sedište firme) компании.", 
        tip: "<p>Необходимо, если собственник вашей съёмной квартиры категорически запретил регистрировать бизнес по адресу проживания. Проверяйте ИНН (PIB) арендодателя офиса через реестр APR.</p>" 
      },
      { 
        id: "m3_bank_personal", 
        ...
        tip: "<p><b>Физический шаг:</b> Требуется загранпаспорт и действующий белый картон. Нужен для личных трат, оплат внутри Сербии и связи с облачными сервисами.</p>" 
      },
      { 
        id: "m3_bank_business", 
        ...
        tip: "<p><b>Физический шаг:</b> Делается строго после получения документов из APR. Банк затребует налоговые декларации из РФ (задача <b>tax_decl_bank</b>) для прохождения службы комплаенса. Одобрение счёта занимает 3–10 рабочих дней.</p>" 
      },
      { 
        id: "tax_decl_bank", 
        ...
        cost: 0, 
        currency: "EUR", 
        desc: "Предоставление справок 2-НДФЛ / 3-НДФЛ службе комплаенса.", 
        tip: "<p>Необходимо для подтверждения легальности происхождения ваших средств согласно директивам Народного банка Сербии (NBS). Выписки по счетам из РФ берите сразу на английском языке.</p>" 
      },
      { 
        id: "m3_lawyer", 
        name: "Услуги юриста / адвоката", 
        cost: 200, 
        currency: "EUR", 
        desc: "Сопровождение процедур банковского комплаенса и легализации.", 
        tip: "<p><b>⚠️ Важно:</b> Оказывать юридические услуги в стране имеет право только лицензированный адвокат. Проверяйте статус специалиста в реестре на сайте Адвокатской палаты Сербии (AKS).</p>" 
      }
    ]
  },
  {
    month: 4,
    title: "Месяц 4: Жизнь на рельсах бизнеса и замена ВУ",
    ...
    tasks: [
      { 
        ...
        tip: "<p>Регулярные плановые расходы на содержание жилья.</p>" 
      },
      { 
        id: "m4_kindergarten", 
        ...
        cost: 400, 
        currency: "EUR", 
        desc: "Регулярный платёж за посещение детского сада.", 
        tip: "<p><b>Лайфхак:</b> Возьмите у руководства сада справку с синей печатью (Potvrda o pohađanju vrtića). Это весомое доказательство интеграции семьи для инспектора МУП при продлении ВНЖ на следующий год.</p>" 
      },
      { 
        id: "m4_pausal", 
        ...
        cost: 350, 
        currency: "EUR", 
        desc: "Ежемесячный обязательный паушальный налог в Налоговое управление.", 
        tip: "<p><b>Сроки:</b> Налоги уплачиваются строго до 15-го числа каждого текущего месяца за предыдущий. Налоговое решение (Rešenje) приходит в электронный кабинет на портале Poreska uprava. Не допускайте просрочек!</p>" 
      },
      { 
        id: "state_health_insurance", 
        name: "Оформление государственной медстраховки", 
        cost: 0, 
        currency: "EUR", 
        desc: "Получение пластиковых здравственных книжиц в фонде RFZO на всю семью.", 
        tip: "<p><b>Что это дает:</b> Полноценный бесплатный доступ к медицине в государственных поликлиниках (Dom Zdravlja). На основании уплаты соцвзносов вашего ИП фонд вписывает жену и ребёнка в вашу страховку.</p>" 
      },
      { 
        id: "m4_living", 
        name: "Еда и быт", 
        ...
        tip: "<p>Стабильные издержки на продукты, транспорт и хозяйственные нужды.</p>" 
      },
      { 
        id: "m4_license_trans", 
        ...
        tip: "<p><b>Физический шаг:</b> Переводчик подготовит бумажный перевод с синей печатью и официальной сшивкой за 1–2 дня.</p>" 
      },
      { 
        id: "m4_license_med", 
        ...
        tip: "<p><b>Физический шаг:</b> Пройдите быстрый осмотр (окулист, терапевт, психиатр) по программе 'Lekarski pregled za vozače'. Справка выдаётся сразу на руки.</p>" 
      },
      { 
        id: "m4_license_mup", 
        ...
        cost: 0, 
        currency: "EUR", 
        desc: "Личный визит в Saobraćajna policija (ул. Лєрмонтова 12а) для сдачи документов.", 
        tip: "<p><b>Физический шаг:</b> Предоставьте: оригинал ВУ РФ, судебный перевод прав, медицинскую справку, ID-карту ВНЖ и чеки об оплате пошлин МУП. Внимание: российское ВУ изымается и отправляется в архив, взамен выдаётся сербский пластик.</p>" 
      }
    ]
  }
];
...
function renderSchema() {
  ...
  const items = [
    ...
    {id:'m3_bank_personal',t:'🏦 Личный счёт', icon:'🏦'},
    {id:'m3_bank_business',t:'💼 Бизнес-счёт', icon:'💼'},
    {id:'m4_license_trans',t:'📄 Перевод прав', icon:'📄'},
    {id:'m4_license_med',t:'🩺 Медкомиссия ВУ', icon:'🩺'},
    {id:'m4_license_mup',t:'🚗 Обмен ВУ в MUP', icon:'🚗'},
  ];
