window.APP_CONFIG = {
  VERSION: "1.44.0",
  BUILD: "dd6245e",
  CACHE_NAME: "relocation-v1.44.0-dd6245e"
};
  ...
  marker.bindPopup(`
    <div style="font-family:sans-serif;max-width:220px">
      ...
      <div style="display:flex;flex-direction:column;gap:4px;margin-top:6px">
        ...
        ${pt.gmapUrl ? `<a href="${pt.gmapUrl}" target="_blank" rel="noopener noreferrer" class="poi-gmap-btn" style="display:inline-flex;align-items:center;justify-content:center;gap:4px;padding:6px;border-radius:6px;background:#4285f4;color:#fff;text-decoration:none;font-size:11px;font-weight:bold">🗺️ Открыть в Google Maps</a>` : ''}
