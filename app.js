window.APP_CONFIG = {
  VERSION: "1.20.0",
  BUILD: "9322928",
  CACHE_NAME: "relocation-v1.20.0-9322928"
};
...
const masterTimeline = [
  {
    ...
    tasks: [
      ...
      { id: "p5d", name: "Загранпаспорт ребёнка (5 лет)", cost: 3000, currency: "RUB", desc: "Старый образец на 5 лет, оформить после штампа о гражданстве", tip: "<p><b>Где делать:</b> Через <a href='https://www.gosuslugi.ru' target='_blank' rel='noopener'>Госуслуги</a> или МФЦ. Ребёнку до 14 лет — паспорт старого образца (без биометрии) на 5 лет.</p><p><b>Обязательное условие:</b> На свидетельстве о рождении <b>должен стоять штамп о гражданстве РФ</b> (красная печать на обратной стороне).</p><p><b>Пошлина:</b> 2 500 руб (дети до 14 лет).</p><p><b>Срок:</b> 1 месяц.</p><p><b>⚠️ Важно:</b> Загранпаспорт ребёнка понадобится для прохождения границы, подачи на ВНЖ и зачисления в детский сад.</p>", hasDate: true, expires: 60 },
