window.APP_CONFIG = {
  VERSION: "6.1.0",
  BUILD: "c243d7c",
  CACHE_NAME: "relocation-v6.1.0-c243d7c"
};
...
const masterTimeline = [
  {
    ...
    tasks: [
      ...
      { 
        ...
        tip: "<p><b>Зачем:</b> Чтобы сербские органы приняли российскую справку о несудимости, на неё необходимо проставить апостиль. Хотя договор 1962 года освобождает от апостиля, на практике сербский МУП часто требует его, чтобы не разбираться с юридическими тонкостями международных соглашений.</p><p><b>Где делать:</b> В Главном управлении ЗАГС вашего региона или через МФЦ. Срок 5 рабочих дней.</p><p><b>Пошлина:</b> 2 500 руб.</p>" 
      },
      { 
        id: "apost_nocrim_w", 
        ...
        tip: "<p><b>Зачем:</b> Аналогичная процедура для справки о несудимости жены. Рекомендуется сделать сразу обе, чтобы при подаче на ВНЖ не было задержек из-за отсутствия апостиля на одном из документов.</p><p><b>Где делать:</b> В том же отделении ЗАГС или МФЦ одновременно с апостилем мужа.</p><p><b>Пошлина:</b> 2 500 руб.</p>" 
      },
      { 
        id: "power", 
  ...
  },
  {
    ...
    tasks: [
      ...
      { 
        ...
        tip: "<p><b>⚠️ Подводный камень:</b> Оплатить пошлины картой иностранного банка онлайн невозможно. Сгенерируйте квитанции на eUprava через систему Plati, распечатайте их, дойдите ногами до ближайшей Почты и оплатите наличными динарами. Сохраните бумажные чеки с мокрой печатью для загрузки на портал eUprava.</p>" 
      },
      { 
        id: "m1_vnz_submit", 
  ...
  },
  {
    ...
    tasks: [
      ...
      { 
        ...
        tip: "<p><b>Физический шаг:</b> Делается строго ПОСЛЕ получения решения из APR (задача preduzetnik). Банк затребует документы 2-НДФЛ/3-НДФЛ из РФ (задача tax_decl_bank) для проверки легальности происхождения капитала. Одобрение бизнес-комплаенса занимает от 3 до 10 рабочих дней.</p>" 
      },
      { 
        id: "tax_decl_bank", 
  ...
  },
  {
    ...
    tasks: [
      ...
      { 
        ...
        tip: "<p><b>Физический шаг:</b> Запишитесь на осмотр 'Lekarski pregled za vozače'. Пройдите окулиста, терапевта и психиатра. Справка выдаётся сразу на руки, срок её действия строго ограничен. Это второй из трёх шагов обмена ВУ.</p>" 
      },
      { 
        id: "m4_license_mup", 
        ...
        tip: "<p><b>Физический шаг:</b> Возьмите с собой: оригинал ВУ РФ, перевод прав, медицинскую справку, ID-карту ВНЖ и оплаченные на почте таксы МУП. Внимание: российское ВУ у вас заберут и отправят в архив, взамен выдадут сербский биометрический пластик. <a href='https://mup.gov.rs' target='_blank'>Сайт МВД Сербии</a>.</p>" 
      }
    ]
  }
];
