...
const CHECKLIST = [
  ...
  { cat: "🚗 Транспорт / Автомобиль", items: [
    ...
    { id:"car_docs", text:"СТС и ПТС (оригиналы на машину)", price:"", link:"", tip:"Для ввоза или перерегистрации авто в Сербии.\nСделать нотариальные копии — оригиналы лучше не возить с собой каждый день." },
  ]},
  { cat: "📱 Прочее", items: [
