...
const CHECKLIST = [
  ...
  { cat: "📄 Документы в Сербии", items: [
    ...
    { id:"vnd", text:"Единое разрешение (ВНЖ + разрешение на работу)", price:"18000 RSD", link:"", tip:"Подача на ВНЖ (временный боравак) в Сербии теперь полностью объединена с разрешением на работу в один документ — Jedinstvena dozvola.\n\nШаг 1: Подача документов осуществляется ОНЛАЙН через портал eUprava (никаких живых очередей в МУП для подачи).\nШаг 2: Оплатить пошлину (около 18 000 RSD).\nШаг 3: Дождаться одобрения в личном кабинете и прийти в МУП только на сканирование биометрии и получение готовой пластиковой карты." },
